  ...
  return (
    <div className="camper-mods-style">
      <p>
        ...
        <a
          href="https://www.amazon.com/gp/product/B000W7DBWA/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        from storage, and means we lock it more frequently. I also got this{" "}
        <a
          href="https://www.amazon.com/gp/product/B004ONNA42/"
          target="_blank"
          rel="noreferrer"
        >
          rubber dust cover
        </a>{" "}
        for it to make the lock last longer, and sort of hide the fact that
...
export default KeylessLockStorage;
