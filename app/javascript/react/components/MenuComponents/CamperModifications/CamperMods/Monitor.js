  ...
  return (
    <div className="camper-mods-style">
      <p>
        ...
        was shopping around, I decided to keep my eye open for one that had HDMI
        inputs and could run off 12VDC (or less). Amazingly, I found exactly
        what I was looking for in{" "}
        <a
          href="https://www.amazon.com/gp/product/B0773ZY26F/"
          target="_blank"
          rel="noreferrer"
        >
          this relatively cheap Sceptre 24&quot; monitor
        </a>
