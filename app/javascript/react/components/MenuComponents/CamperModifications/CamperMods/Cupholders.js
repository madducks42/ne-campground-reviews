  ...
  return (
    <div>
      <p className="is-size-7 mb-4">
        This is another easy mod, but you need to be brave enough to cut very
        visible holes in your camper...
      </p>
      <p className="is-size-7 mb-4">
        When relaxing on the bed, the headboard/shelf at the head of the bed is
        the only place to rest anything. But resting beverages here is a bit
        risky. So we decided to add some cup holders here.
      </p>
      <p className="is-size-7 mb-4">
        I found{" "}
        <a
          href="https://www.amazon.com/gp/product/B018380HGM"
          target="_blank"
          rel="noreferrer"
        >
          these cup holder inserts
        </a>{" "}
        on Amazon. The color matches the camper perfectly, and they&apos;re big
        enough to hold a beverage in a koozie.
      </p>
      <p className="is-size-7 mb-4">
        Installation is easy. Find a 3-1/2&quot; hole saw, and cut a hole. These
        inserts require a little pressure to get in place. But the snug is
        actually perfect to keep them in place.
      </p>
