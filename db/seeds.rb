...
user_4 =
  User.create(
    first_name: 'Zoe',
    last_name: 'Washbourne',
    email: 'zoe@gmail.com',
    username: 'shouldabeencaptain',
    password: 'password',
    role: 'member'
  )
user_5 =
...
review_2 =
  Review.create(
    ...
    body:
      'Really enjoyed our stay! Campground was super clean and well-maintained!',
    rating: 5,
    campground: campground_3,
    user: user_1
  )
review_3 =
  Review.create(
    title: 'Nice campground',
    body: 'Nice pretty campground',
    rating: 4,
...
review_4 =
  Review.create(
    title: 'Quiet campground',
    body: 'Pretty and quiet campground',
    rating: 4,
    campground: campground_3,
    user: user_4
  )
review_5 =
  Review.create(
    ...
    body: 'Great campground for kids. The lake was really nice!',
    rating: 5,
    campground: campground_1,
    user: user_4
  )
review_6 =
  Review.create(
    title: 'Terrible campground',
    body: 'Dirt and bugs everywhere. Nature is the worst.',
    rating: 1,
    campground: campground_1,
    user: user_2
  )
